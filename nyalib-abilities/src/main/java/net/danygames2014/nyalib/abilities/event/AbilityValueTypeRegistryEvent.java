...
public class AbilityValueTypeRegistryEvent extends Event {
    public <T> void register(String type, AbilityValueFactory<T> factory, Class<? extends AbilityValue<?>> valueClass) {
        AbilityValueTypeRegistry.register(type, factory, valueClass);
    }
}
