...
public class SimpleFluidTankScreenHandler extends ScreenHandler {
    public PlayerEntity player;
    public Inventory playerInventory;

    public SimpleFluidTankBlockEntity fluidTank;

    public SimpleFluidTankScreenHandler(PlayerEntity player, SimpleFluidTankBlockEntity fluidTank) {
        this.player = player;
