...
public class ManagedFluidTankScreenHandler extends ScreenHandler {
    public PlayerEntity player;
    public Inventory playerInventory;

    public ManagedFluidTankBlockEntity fluidTank;

    public ManagedFluidTankScreenHandler(PlayerEntity player, ManagedFluidTankBlockEntity fluidTank) {
        this.player = player;
