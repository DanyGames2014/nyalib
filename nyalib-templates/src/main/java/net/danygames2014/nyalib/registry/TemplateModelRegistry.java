...
public class TemplateModelRegistry {
    ...
    public static HashMap<Identifier, Identifier> generatedItems = new HashMap<>();
    ...
    // Template Items
    public static void registerGeneratedItem(Identifier itemIdentifier, Identifier texture) {
        generatedItems.put(itemIdentifier, texture);
        
        if (FabricLoader.getInstance().getEnvironmentType() == EnvType.SERVER) {
            return;
        }

        JsonOverrideRegistry.registerItemModelOverride(itemIdentifier, generatedItemJson);
        JsonOverrideRegistry.registerItemModelTextureOverride(itemIdentifier, "layer0", texture);
    } 
    ...
    public static final String generatedItemJson = ("""
            {
